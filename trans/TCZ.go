...
// TRANS_REVERSAL
func ZReversal8583(down *easy8583.Easy8583, up *easy8583.Easy8583) []byte {
	s := down
	field := down.Field_S
	...
	if up.Field_R[13].Data != nil { // 预授权完成撤销没有传卡有效期
		//14域 卡有效期 N4
		field[13].Ihave = true
	...
	if up.Field_R[22].Data != nil { // 预授权完成撤销没有传卡序列号
		//23域 卡序列号
		field[22].Ihave = true
	...
	field[59].Data = byteutil.HexStringToBytes("000001000601")
